...
public class WildCardExample<T> {
	...
	public static void main(String[] args) {
		...
		//List of great grand childern
//		List<GreatGrandChildClass> greatGrandChildren = new ArrayList<GreatGrandChildClass>();
//		greatGrandChildren.add(new GreatGrandChildClass());
//		addGrandChildren(greatGrandChildren);
